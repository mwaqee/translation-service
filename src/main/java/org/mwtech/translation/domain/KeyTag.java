...
public class KeyTag {
  @Id @Column(name="key_id") private Long keyId;
  @Id @Column(name="tag_id") private Long tagId;

  public KeyTag() {}
  public KeyTag(Long keyId, Long tagId){ this.keyId=keyId; this.tagId=tagId; }
  ...
  public static class KeyTagId implements Serializable {
    public Long keyId; public Long tagId;
    public KeyTagId() {}
    ...
    @Override public int hashCode(){ return Objects.hash(keyId,tagId); }
  }
}
